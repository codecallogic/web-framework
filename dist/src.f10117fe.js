...
var Eventing = function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || []; // array of Callback [] or undefined
...
var User = function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User( //// Gives the ability to store properties tied to this user (name, age, etc)
    new Attributes_1.Attributes(attrs), //// Gives us the ability to tell other parts of our application whenever data tied to a particular user is changed
    new Eventing_1.Eventing(), //// Gives us the ability to save this persons data to a remote server, then retrieve it in the future
...
collection.fetch();
},{"./models/User":"src/models/User.ts"}],"../../../../../../Users/fabricio/.nvm/versions/node/v14.15.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../Users/fabricio/.nvm/versions/node/v14.15.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
